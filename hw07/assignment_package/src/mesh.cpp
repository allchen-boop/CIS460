    ...
    for (uPtr<Face> &f : faces) {
        ...
        do {
            ...
            if (!vertex->influences.empty()) {
                jointID.push_back(glm::ivec2(vertex->influences[0].first,
                                             vertex->influences[1].first));
                jointWeight.push_back(glm::vec2(vertex->influences[0].second,
                                                vertex->influences[1].second));
            }
