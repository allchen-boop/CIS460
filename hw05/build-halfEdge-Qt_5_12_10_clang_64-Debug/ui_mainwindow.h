...
public:
    ...
    QLabel *labelJointInfoPosition;
    QLabel *labelJointInfoRotate;
    QMenuBar *menuBar;
    QMenu *menuFile;
    QMenu *menuHelp;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelJointInfoPosition = new QLabel(centralWidget);
        labelJointInfoPosition->setObjectName(QString::fromUtf8("labelJointInfoPosition"));
        labelJointInfoPosition->setGeometry(QRect(10, 450, 621, 20));
        labelJointInfoPosition->setAlignment(Qt::AlignCenter);
        labelJointInfoRotate = new QLabel(centralWidget);
        labelJointInfoRotate->setObjectName(QString::fromUtf8("labelJointInfoRotate"));
        labelJointInfoRotate->setGeometry(QRect(10, 470, 621, 20));
        labelJointInfoRotate->setAlignment(Qt::AlignCenter);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelJointInfoPosition->setText(QApplication::translate("MainWindow", "select a joint to see its current transformation!", nullptr));
        labelJointInfoRotate->setText(QString());
