...
void Mesh::createCube(const char *textureFile, const char *bgTextureFile)
{
    ...
    std::vector<glm::vec2> frontUvs {glm::vec2(0, 0),
                                     glm::vec2(1, 0),
                                     glm::vec2(1, 1),
                                     glm::vec2(0, 1)};

    std::vector<glm::vec2> backUvs = frontUvs,
                           leftUvs = frontUvs,
                           rightUvs = frontUvs,
                           topUvs = frontUvs,
                           bottomUvs = frontUvs;

    std::vector<glm::vec2> uvs = frontUvs;
    uvs.insert(uvs.end(), backUvs.begin(), backUvs.end());
    uvs.insert(uvs.end(), leftUvs.begin(), leftUvs.end());
    uvs.insert(uvs.end(), rightUvs.begin(), rightUvs.end());
    uvs.insert(uvs.end(), topUvs.begin(), topUvs.end());
    uvs.insert(uvs.end(), bottomUvs.begin(), bottomUvs.end());
