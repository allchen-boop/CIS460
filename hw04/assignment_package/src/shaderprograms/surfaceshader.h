...
public:
    ...
    // added in
    int unifCam; // A handle to a uniform vec3 that represents your camera's position in world space
...
public:
    ...
    // update camera position variable in GPU
   void setCamPos(const glm::vec3 &cam);
};
