...
void MyGL::createShaders()
{
    ...
    std::shared_ptr<PostProcessShader> trippy = std::make_shared<PostProcessShader>(this);
    trippy->create(":/glsl/post/passthrough.vert.glsl", ":/glsl/post/trippy.frag.glsl");
    m_postprocessShaders.push_back(trippy);
