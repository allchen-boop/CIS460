...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    case Qt::Key_W : rasterizer.cam.moveForward(0.5); break;
    case Qt::Key_S : rasterizer.cam.moveForward(-0.5); break;
    case Qt::Key_A : rasterizer.cam.moveRight(-0.5); break;
    case Qt::Key_D : rasterizer.cam.moveRight(0.5); break;
    case Qt::Key_Q : rasterizer.cam.moveUp(0.5); break;
    case Qt::Key_E : rasterizer.cam.moveUp(-0.5); break;
