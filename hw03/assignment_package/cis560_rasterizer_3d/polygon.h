...
struct Vertex
{
    ...
    // added in
    glm::vec4 m_posc;   // The copy of the vertex position (for interactive camera)
...
public:
    ...
    // INTERPOLATION BUSINESS
    glm::vec3 interpolate(Vertex v1, Vertex v2, Vertex v3, float x, float y);
    glm::vec4 baryArea(Vertex v1, Vertex v2, Vertex v3, float x, float y);
    float interpolateZ(Vertex v1, Vertex v2, Vertex v3, float x, float y);
    glm::vec2 interpolateUV(Vertex v1, Vertex v2, Vertex v3, float x, float y, float zInt);
    glm::vec4 interpolateNormal(Vertex v1, Vertex v2, Vertex v3, float x, float y, float zInt);
};
